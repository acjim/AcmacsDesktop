...
var api = function ($q, $timeout) {
     ...
     * @memberof api
     * @param {Object} additional_params = {  disconnected: list, projection: int }
     * @param output_acd1
     * @returns {Object} {output_json: output_json, updated_acd1: output_acd1_1}
     */
     ...
     * @memberof api
     * @param {Object} additional_params = {  unmovable: list, projection: int }
     * @param output_acd1
     * @returns {Object} {output_json: output_json, updated_acd1: output_acd1_1}
     */
...
angular.module('acjim.api', []).factory('api', ['$q', '$timeout',apiFactory]);